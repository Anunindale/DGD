 ...
 * It is not generic.
 */
public class JournalLinesLookupRelationManager extends EMCLookupRelationManager {
    ...
    private String transactions = InventoryTransactions.class.getName();
    ...
    /** Creates a new instance of JournalLinesLookupRelationManager.  Takes the field names of the item and dimension fields on the table to relate as parameters. */
    public JournalLinesLookupRelationManager(String itemField, String dim1Field, String dim2Field, String dim3Field, String warehouseField, String locationField) {
        super();
    ...
    public void doRowChanged(emcDataRelationManagerUpdate drm) {
        ...
        EMCLookup theLookup = getLookupFromName("location").get(0);
        theQuery = theLookup.getTheQuery();
