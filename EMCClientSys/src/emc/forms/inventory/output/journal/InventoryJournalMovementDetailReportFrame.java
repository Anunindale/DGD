 ...
 * @author wikus
 */
public class InventoryJournalMovementDetailReportFrame extends ReportFrame {

    public InventoryJournalMovementDetailReportFrame(EMCUserData userData) {
        super("Journal Movement - Detail", EnumReports.INVENTORY_MOVEMENT_JOURNAL_DETAIL, userData);
    }
    ...
    protected JasperInformation createJasperInfo() {
        ...
        jasperInfo.setJasperTemplate("/emc/reports/inventory/journals/InventoryJournalMovementDetailReport.jrxml");
        jasperInfo.setXmlNodePath("/emcmsg/emc.reports.inventory.journals.InventoryMovementJournalSummaryDS");
        jasperInfo.setReportTitle("Journal Movement - Detail");
    ...
    protected EMCCommandClass createReportCommand() {
        return new EMCCommandClass(EMCCommands.REPORT_COMAND.getId(), enumEMCModules.INVENTORY.getId(), ServerInventoryMethods.PRINT_MOVEMENT_JOURNAL_DETAIL.toString());
    }
}
