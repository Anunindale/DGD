 ...
 */
package emc.forms.creditors.display.creditnote;
...
import emc.forms.creditors.display.creditnote.resources.CreditorsCreditNoteLinesDRM;
import emc.forms.creditors.display.creditnote.resources.CreditorsCreditNoteLinesLRM;
import emc.forms.creditors.display.creditnote.resources.CreditorsCreditNoteMasterDRM;
 ...
 * @author wikus
 */
public class CreditorsCreditNoteForm extends BaseInternalFrame {

    private EMCUserData masterUD;
    private CreditorsCreditNoteMasterDRM masterDRM;
    private EMCUserData linesUD;
    private CreditorsCreditNoteLinesDRM linesDRM;
    //Lookups for LRM
    ...
    public CreditorsCreditNoteForm(EMCUserData userData) {
        super("Creditors CreditNote", true, true, true, true, userData);
        ...
        if (masterUD.getUserData(0) == null) {
            ...
            query.addOr("creditNoteInvoiceType", CreditorsCreditNoteInvoiceType.MANUAL_CREDIT_NOTE.toString());
            query.addOr("creditNoteInvoiceType", CreditorsCreditNoteInvoiceType.PURCHASING_CREDIT_NOTE.toString());
            query.closeConditionBracket();
            masterUD.setUserData(0, query);
        }

        masterDRM = new CreditorsCreditNoteMasterDRM(new emcGenericDataSourceUpdate(new CreditorsCreditNoteInvoiceMasterDS(), masterUD), masterUD);
        ...
        linesDRM = new CreditorsCreditNoteLinesDRM(new emcGenericDataSourceUpdate(new CreditorsCreditNoteInvoiceLinesDS(), linesUD), param, linesUD);
    ...
    private void setupItemDimLookups() {
        ...
        CreditorsCreditNoteLinesLRM linesLRM = new CreditorsCreditNoteLinesLRM("itemId", "dimension1", "dimension2", "dimension3", "warehouse");
