 ...
 * @author wikus
 */
public class CreditorsInvoiceLinesLRM extends EMCLookupRelationManager {
    ...
    public CreditorsInvoiceLinesLRM(String itemField, String dim1Field, String dim2Field, String dim3Field, String warehouseField) {
        super();
