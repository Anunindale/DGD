 ...
 * @author wikus
 */
public class SOPSalesOrderReportForm extends ReportFrame {

    /** Creates a new instance of DebtorsCustomerAgingDetailedReportForm */
    public SOPSalesOrderReportForm(EMCUserData userData) {
        super("Sales Orders", EnumReports.SOP_SALES_ORDERS, userData);
    }
    ...
    protected JasperInformation createJasperInfo() {
        ...
        jasperInfo.setJasperTemplate("/emc/reports/sop/salesorder/SOPSalesOrdersReport.jrxml");
        jasperInfo.setXmlNodePath("/emcmsg/emc.reports.sop.salesorders.SOPSalesOrdersReportDS");
        jasperInfo.setReportTitle("Sales Orders");
    ...
    protected EMCCommandClass createReportCommand() {
        return new EMCCommandClass(EMCCommands.REPORT_COMAND.getId(), enumEMCModules.SOP.getId(), ServerSOPMethods.PRINT_SOP_SALES_ORDERS.toString());
    }
}
