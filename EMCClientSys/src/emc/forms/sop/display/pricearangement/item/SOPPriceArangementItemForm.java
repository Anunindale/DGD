 ...
 */
package emc.forms.sop.display.pricearangement.item;
 ...
 * @author wikus
 */
public class SOPPriceArangementItemForm extends BaseInternalFrame {
    ...
    public SOPPriceArangementItemForm(EMCUserData userData) {
        ...
        dataManager = new StockControlLookupDRM(new emcGenericDataSourceUpdate(enumEMCModules.SOP.getId(), new SOPPriceArangementsDS(), userData), param, userData) {
            ...
            public void doRelation(int rowIndex) {
                ...
                if (table != null) {
                    cbCustomerType.setSelectedItem(((StockControlLookupDRM) getDataManager()).getLastFieldValueAt("customerType"));
                }
            }
...
//                    this.setFieldValueAt(rowIndex + 1, "itemId", this.getFieldValueAt(rowIndex, "itemId"));
    ...
    private emcJPanel lookupPane() {
        ...
        userData.setUserData(4, "itemReference");
        lkpItem = new EMCItemControlLookup(new  ItemMaster(), dataManager, "itemId", txtDescription, "description", SOPPriceArangements.class.getName(), null);
        lkpItem.setPopup(new ItemReferencePopup("itemId", userData));
        lkpItem.setReferenceField("itemReference");
        ...
        dataManager.setLookup(lkpItem);
        Component[][] comp = {{new emcJLabel("Item"), lkpItem, new emcJLabel("Description"), txtDescription}};
        return emcSetGridBagConstraints.createSimplePanel(comp, GridBagConstraints.NONE, true, "Item");
    }
...
//            }
    ...
    private void setupLookups(final emcJTableUpdate table) {
        ...
        params.setFormItemLookup(lkpItem);
