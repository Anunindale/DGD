package emc.forms.hr.display.trainingreason;
 ...
 * @author claudette
 */
public class HRTrainingReasonForm extends BaseInternalFrame {

    private emcDataRelationManagerUpdate drm;

    /** Creates a new instance of HRTrainingReasonForm. */
    public HRTrainingReasonForm(EMCUserData userData) {
        super("Training Reason", true, true, true, true, userData);
        this.setBounds(20, 20, 650, 290);
        drm = new emcDataRelationManagerUpdate(new emcGenericDataSourceUpdate(new HRTrainingReason(), userData), userData);
        drm.setTheForm(this);
        this.setDataManager(drm);
        drm.setFormTextId1("trainingReasonId");
