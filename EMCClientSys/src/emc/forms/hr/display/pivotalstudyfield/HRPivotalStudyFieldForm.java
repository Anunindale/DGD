package emc.forms.hr.display.pivotalstudyfield;
 ...
 * @author claudette
 */
public class HRPivotalStudyFieldForm extends BaseInternalFrame {

    private emcDataRelationManagerUpdate drm;

    /** Creates a new instance of HRPivotalStudyFieldForm. */
    public HRPivotalStudyFieldForm(EMCUserData userData) {
        super("Pivotal Study Field", true, true, true, true, userData);
        this.setBounds(20, 20, 650, 290);
        drm = new emcDataRelationManagerUpdate(new emcGenericDataSourceUpdate(new HRPivotalStudyField(), userData), userData);
        drm.setTheForm(this);
        this.setDataManager(drm);
        drm.setFormTextId1("pivotalStudyFieldId");
