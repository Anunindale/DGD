package emc.forms.hr.display.trainingtype;
 ...
 * @author claudette
 */
public class HRTrainingTypeForm extends BaseInternalFrame {

    private emcDataRelationManagerUpdate drm;

    /** Creates a new instance of HRTrainingTypeForm. */
    public HRTrainingTypeForm(EMCUserData userData) {
        super("Training Type", true, true, true, true, userData);
        this.setBounds(20, 20, 650, 290);
        drm = new emcDataRelationManagerUpdate(new emcGenericDataSourceUpdate(new HRTrainingType(), userData), userData);
        drm.setTheForm(this);
        this.setDataManager(drm);
        drm.setFormTextId1("trainingTypeId");
