 ...
 * @author wikus
 */
public class DebtorDeliveryNoteReportForm extends ReportFrame {

    /** Creates a new instance of DebtorsCustomerAgingDetailedReportForm */
    public DebtorDeliveryNoteReportForm(EMCUserData userData) {
        super("Delivery Note", EnumReports.DEBTORS_DELIVERY_NOTE, userData);
    }
