 ...
 * @author riaan
 */
public class CreditNoteLinesLRM extends EMCLookupRelationManager {
    ...
    /** Creates a new instance of CreditNoteLinesLRM.  Takes the field names of the item and dimension fields on the table to relate as parameters. */
    public CreditNoteLinesLRM(String itemField, String dim1Field, String dim2Field, String dim3Field, String warehouseField, String locationField) {
        super();
