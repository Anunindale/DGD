...
public class BugListReportForm extends ReportFrame {

    public BugListReportForm(EMCUserData userData) {
        super("Task List", EnumReports.DEV_TOOLS_BUG_LIST, userData);
    }
    ...
    protected DefaultReportQuery createDefaultQuery() {
        ...
        tables.addTable(DevTimeSheet.class.getName(), "taskRecordId", DevBugsTable.class.getName(), "recordID");
