package emc.forms.hr.display.remunerantiontype;
...
* @author claudette
*/
public class HRRemunerantionTypeForm extends BaseInternalFrame{

    private emcDataRelationManagerUpdate drm;

    /** Creates a new instance of HRRemunerantionTypeForm. */
    public HRRemunerantionTypeForm(EMCUserData userData) {
        super("Remuneration Type", true, true, true, true, userData);
        this.setBounds(20, 20, 650, 290);
        drm = new emcDataRelationManagerUpdate(new emcGenericDataSourceUpdate(new HRRemunerantionType(), userData), userData);
        drm.setTheForm(this);
        this.setDataManager(drm);
        drm.setFormTextId1("remunerationType");
