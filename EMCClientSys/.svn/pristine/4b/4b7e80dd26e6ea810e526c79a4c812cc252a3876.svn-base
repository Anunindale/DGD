 ...
 */
package emc.forms.base.display.sendmsg.resources;
 ...
 * @author rico
 */
public class SendButton extends emcJButton {

    private emcDataRelationManagerUpdate dataRelation;
    private emcJTextArea message;
    private emcJLabel sendResult;

    public SendButton(emcDataRelationManagerUpdate dataRelation, emcJTextArea message, emcJLabel sendResult) {
        super("OK");
    ...
    public void doActionPerformed(ActionEvent evt) {
        ...
        cmd.setMethodId(emc.methods.base.ServerBaseMethods.ADMIN_MESSAGE_TO_USER.toString());
        List toSend = new ArrayList();
        try {
            toSend.add(dataRelation.getTheForm().getUserData().getUserData(0));
            ...
            sendResult.setText("Message failed. Likely no user selected.");
        }
