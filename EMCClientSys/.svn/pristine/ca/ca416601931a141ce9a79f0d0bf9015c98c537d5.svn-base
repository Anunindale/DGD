package emc.forms.gl.display.groupcompanyaccount;
...
* @author claudette
*/
public class GLGroupCompanyAccountForm extends BaseInternalFrame{

    private emcDataRelationManagerUpdate drm;

    /** Creates a new instance of GLGroupCompanyAccountForm. */
    public GLGroupCompanyAccountForm(EMCUserData userData) {
        super("Group Company Account", true, true, true, true, userData);
        this.setBounds(20, 20, 650, 290);
        drm = new emcDataRelationManagerUpdate(new emcGenericDataSourceUpdate(new GLGroupCompanyAccount(), userData), userData);
        drm.setTheForm(this);
        this.setDataManager(drm);
        drm.setFormTextId1("groupRule");
