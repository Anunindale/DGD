 ...
 * @author riaan
 */
public class SOPOrderScheduleReportForm extends ReportFrame {

    /** Creates a new instance of SOPOrderScheduleReportForm. */
    public SOPOrderScheduleReportForm(EMCUserData userData) {
        super("Order Schedule by Customer", EnumReports.SOP_ORDER_SCHEDULE, userData);
    }
    ...
    protected DefaultReportQuery createDefaultQuery() {
        ...
        orderTable.setField("customerNo");
    ...
    protected JasperInformation createJasperInfo() {
        ...
        jasperInfo.setJasperTemplate("/emc/reports/sop/orderschedule/SOPOrderScheduleReport.jrxml");
        jasperInfo.setXmlNodePath("/emcmsg/emc.reports.sop.orderschedule.SOPOrderScheduleReportDS");
        jasperInfo.setReportTitle("Order Schedule by Customer");
    ...
    protected EMCCommandClass createReportCommand() {
        return new EMCCommandClass(EMCCommands.REPORT_COMAND.getId(), enumEMCModules.SOP.getId(), ServerSOPMethods.PRINT_ORDER_SCHEDULE.toString());
    }
}
