 ...
 * @author wikus
 */
public class ItemClassificationForm6 extends BaseInternalFrame {
    ...
    public ItemClassificationForm6(EMCUserData userData){
        super("Classifications 6", true, true,true, true,userData);
        ...
        try{
            ...
            dataRelation = new emcDataRelationManagerUpdate(new emcGenericDataSourceUpdate(
                        enumEMCModules.INVENTORY.getId(),new emc.entity.inventory.classifications.InventoryItemClassification6(),userData),userData);
