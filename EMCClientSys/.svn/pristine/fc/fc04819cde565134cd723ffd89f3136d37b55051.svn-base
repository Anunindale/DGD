...
import emc.forms.debtors.display.customerinvoice.resources.CreditNoteButton;
...
import emc.forms.debtors.display.customerinvoice.resources.InvCancelButton;
import emc.forms.debtors.display.customerinvoice.resources.InvoicePrintButton;
 ...
 * @author riaan
 */
public class CustomerInvoiceForm extends BaseInternalFrame {
    ...
    private emcJLabel lblBillingCurrency;
    private EMCLookupFormComponent lkpBillingCurrency;
    // </editor-fold>
     ...
     */
    public CustomerInvoiceForm(EMCUserData userData) {
        super("Customer Invoices", true, true, true, true, userData);
        this.setBounds(20, 20, 870, 720);

        EMCUserData linesUD = userData.copyUserData();

        masterDRM = new CustomerInvoiceMasterDRM(new emcGenericDataSourceUpdate(enumEMCModules.DEBTORS.getId(), new DebtorsCustomerInvoiceMasterDS(), userData), userData);
    ...
    private void initLabels() {
        ...
        this.lblCustomerContact = new emcJLabel(masterDRM.getColumnName("customerContact"));
        this.lblBillingCurrency = new emcJLabel("Billing Currency");
    ...
    private void initLookups(EMCUserData userData) {
        ...
        this.lkpBillingCurrency = new EMCLookupFormComponent(new emc.menus.gl.menuitems.display.GLCurrency(), masterDRM, "billingCurrency");
        this.lkpBillingCurrency.setPopup(new EMCLookupPopup(new GLCurrency(),"currency",userData));
...
//        });
    ...
    private emcJPanel createMasterPricePaymentTab() {
        Component[][] components = new Component[][]{
            ...
            {lblSettlementDiscCode, lkpSettlementDiscCode,lblBillingCurrency,lkpBillingCurrency},
