 ...
 * @author wikus
 */
public class SOPCommissionReport extends ReportFrame {

    /** Creates a new instance of DebtorsCustomerAgingDetailedReportForm */
    public SOPCommissionReport(EMCUserData userData) {
        super("Commission By Brand", EnumReports.SOP_COMMISSION, userData);
    }
    ...
    protected JasperInformation createJasperInfo() {
        ...
        jasperInfo.setJasperTemplate("/emc/reports/sop/commission/SOPCommissionReport.jrxml");
        jasperInfo.setXmlNodePath("/emcmsg/emc.reports.sop.commission.SOPCommissionReportDS");
        jasperInfo.setReportTitle("Commission By Brand");
    ...
    protected EMCCommandClass createReportCommand() {
        return new EMCCommandClass(EMCCommands.REPORT_COMAND.getId(), enumEMCModules.SOP.getId(), ServerSOPMethods.PRINT_COMMISSION_REPORT.toString());
    }
