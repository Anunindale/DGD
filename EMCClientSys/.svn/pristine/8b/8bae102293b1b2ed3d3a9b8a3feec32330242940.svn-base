 ...
 */
package emc.forms.inventory.output.stockvaluation;

import emc.forms.inventory.output.onhand.*;
 ...
 * @author wikus
 */
public class StockValuationReportForm extends ReportFrame {

    public StockValuationReportForm(EMCUserData userData) {
        super("Stock Valuation Report", EnumReports.INVENTORY_STOCK_VALUATION, userData);
    }
    ...
    protected JasperInformation createJasperInfo() {
        ...
        jasperInfo.setJasperTemplate("/emc/reports/inventory/stockvaluation/StockValuationReport.jrxml");
        jasperInfo.setXmlNodePath("/emcmsg/emc.reports.inventory.stockvaluation.StockValuationReportDS");
        jasperInfo.setReportTitle("Stock Valuation");
        return jasperInfo;
    }

    @Override
    protected EMCCommandClass createReportCommand() {
        return new EMCCommandClass(EMCCommands.REPORT_COMAND.getId(), enumEMCModules.INVENTORY.getId(), ServerInventoryMethods.PRINT_STOCK_VALUATION_REPORT.toString());
    }
}
