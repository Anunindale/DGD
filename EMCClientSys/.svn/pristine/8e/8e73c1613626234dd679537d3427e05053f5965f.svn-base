 ...
 */
package emc.forms.inventory.display.dimension1groupsetup;
 ...
 * @author riaan
 */
public class Dimension1GroupSetupForm extends BaseInternalFrame {

    private emcJPanel dimension = new emcJPanel();
    private emcJPanel pnlDimensionGroup = new emcJPanel();
    private emcJLabel lblDimensionGroup = new emcJLabel("Config Group");
    ...
    public Dimension1GroupSetupForm(EMCUserData userData) {
        super("Config Group Setup", true, true, true, true, userData);
        ...
        try {
            dataRelation = new EMCControlLookupComponentDRM(new emcGenericDataSourceUpdate(
                    enumEMCModules.INVENTORY.getId(), new emc.entity.inventory.dimensions.datasource.InventoryDimension1GroupSetupDS(), userData), userData);

            lkpDimensionGroup = new EMCControlLookupComponent(new emc.menus.inventory.menuitems.display.Dimension1Groups(), dataRelation, "dimensionGroupId", txtDimensionGroupDesc, "description", InventoryDimension1GroupSetup.class.getName());
            ...
            EMCLookupPopup dimensionGroupPopup = new EMCLookupPopup(enumEMCModules.INVENTORY.getId(), new emc.entity.inventory.dimensions.InventoryDimension1Group(),
            ...
            if (EMCDebug.getDebug()) {
                java.util.logging.Logger.getLogger("emc").log(Level.SEVERE, "Failed to create Config Group Setup Form", userData);
            }
        }
    ...
    private void setupComponents() {
        ...
        lkpDimension = new EMCLookupJTableComponent(new emc.menus.inventory.menuitems.display.Dimension1());
        EMCLookupPopup dimensionPopup = new EMCLookupPopup(enumEMCModules.INVENTORY.getId(), new emc.entity.inventory.dimensions.InventoryDimension1(),
                "dimensionId", dimensionKeys, copyUD);
        dimensionPopup.setPreferredWidth(500);
    ...
    private void createDimensionGroupPanel() {
        pnlDimensionGroup.setBorder(javax.swing.BorderFactory.createTitledBorder("Config Group"));
        int y = 0;
    ...
    private void initFrame() {
        ...
        tabDimension();
        tabbedPanetop.add("Config Group Setup", this.dimension);
