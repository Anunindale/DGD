 ...
 * @author wikus
 */
public class MoveStockMasterDRM extends StockDRM {

    private boolean busy = false;
    private EMCControlLookupComponent lkpLocation;
    private EMCControlLookupComponent lkpWarehouse;

    public MoveStockMasterDRM(emcGenericDataSourceUpdate tableDataSource, StockDRMParameters param, EMCUserData userData) {
