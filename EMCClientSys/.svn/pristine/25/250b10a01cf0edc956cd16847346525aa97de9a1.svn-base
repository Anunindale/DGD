 ...
 * @author riaan
 */
public class ClassificationHierarchyDRM extends emcDataRelationManagerUpdate {
    private Boolean doFormRelation = true;
    /** Creates a new instance of ClassificationHierarchyDRM */
    public ClassificationHierarchyDRM(emcGenericDataSourceUpdate tableDataSource, EMCUserData userData) {
        ...
        switch(Index){
            case 0: 
             ...
             if(hierarchyId != null) {
                 ...
                 if(getDoFormRelation()) setDoFormRelation((Boolean) false);
             }
             break;
