 ...
 * @author wikus
 */
public class ItemClassificationForm2 extends BaseInternalFrame {
    ...
    public ItemClassificationForm2(EMCUserData userData){
        super("Classifications 2", true, true,true, true,userData);
        ...
        try{
            ...
            dataRelation = new emcDataRelationManagerUpdate(new emcGenericDataSourceUpdate(
                        enumEMCModules.INVENTORY.getId(),new emc.entity.inventory.classifications.InventoryItemClassification2(),userData),userData);
