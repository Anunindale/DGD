package emc.forms.hr.display.equitycode;
...
* @author claudette
*/
public class HREquityCodeForm extends BaseInternalFrame{

    private emcDataRelationManagerUpdate drm;

    /** Creates a new instance of HREquityCodeForm. */
    public HREquityCodeForm(EMCUserData userData) {
        super("Equitey Code", true, true, true, true, userData);
        this.setBounds(20, 20, 650, 290);
        drm = new emcDataRelationManagerUpdate(new emcGenericDataSourceUpdate(new HREquityCode(), userData), userData);
        drm.setTheForm(this);
        this.setDataManager(drm);
        drm.setFormTextId1("equityCode");
