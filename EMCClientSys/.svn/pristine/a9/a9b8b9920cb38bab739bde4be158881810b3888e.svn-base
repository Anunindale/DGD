 ...
 * @author rico
 */
public class AgeingDetailReportForm extends ReportFrame {

    public AgeingDetailReportForm(EMCUserData userData) {
        super("Inventory Ageing - Detail", EnumReports.INVENTORY_AGEING_DETAIL, userData);
    ...
    protected JasperInformation createJasperInfo() {
        ...
        jasperInfo.setJasperTemplate("/emc/reports/inventory/ageing/InventoryAgeingDetailedRepor.jrxml");
        jasperInfo.setXmlNodePath("/emcmsg/emc.reports.inventory.ageing.InventoryAgeingDS");
        jasperInfo.setReportTitle("Inventory Ageing - Detail");
        return jasperInfo;
    }

    @Override
    protected EMCCommandClass createReportCommand() {
        return new EMCCommandClass(EMCCommands.REPORT_COMAND.getId(), enumEMCModules.INVENTORY.getId(), ServerInventoryMethods.PRINT_INVENTAGEING_DETAIL.toString());
    }
