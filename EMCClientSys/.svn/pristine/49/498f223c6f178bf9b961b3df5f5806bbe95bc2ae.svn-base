 ...
 * @author riaan
 */
public class ItemClassificationForm1 extends BaseInternalFrame {
    ...
    public ItemClassificationForm1(EMCUserData userData){
        super("Classifications 1", true, true,true, true,userData);
        ...
        try{
            ...
            dataRelation = new emcDataRelationManagerUpdate(new emcGenericDataSourceUpdate(
                        enumEMCModules.INVENTORY.getId(),new emc.entity.inventory.classifications.InventoryItemClassification1(),userData),userData);
