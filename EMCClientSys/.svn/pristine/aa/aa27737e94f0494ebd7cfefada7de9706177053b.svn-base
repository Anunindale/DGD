 ...
 */
package emc.app.components.inventory.register.forms.stocktake;
 ...
 * @author wikus
 */
public class StockTakeRegisterForm extends BaseInternalFrame {
    ...
    public StockTakeRegisterForm(EMCUserData userData) {
        ...
        try {
            ...
            dataRelation = new RegisterDRM(
                    new emcGenericDataSourceUpdate(enumEMCModules.INVENTORY.getId(), new InventoryStocktakeRegister(), userData), false, userData) {

                @Override
                public void setUserData(EMCUserData userData) {
                    super.setUserData(userData);
                    StockTakeRegisterForm.this.userData = userData;

                    StockTakeRegisterForm.this.setTitleValues();
                }
            };
    ...
    private void setTitleValues() {
        ...
        dataRelation.setFormType(RegisterFormTypeEnum.STOCK_TAKE.toString());
    ...
    private emcJPanel titlePane() {
        ...
        Component[][] comps = {{new emcJLabel("Item Id"), txtItem, new emcJLabel("Description"), txtDesc},
            ...
            {new emcJLabel("Total Qty"), txtTotalQty, new emcJLabel("Total Counted Qty"), txtRegisteredQty}};
    ...
    private emcJPanel tablePane() {
        ...
        setupLookups(table);
        table.setColumnEditable("onHandQty", false);
        for (String s : keys) {
            table.setColumnEditable(s, false);
        }
