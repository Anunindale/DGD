 ...
 * @author wikus
 */
public class InventoryStocktakeVarianceReportForm extends ReportFrame {

    public InventoryStocktakeVarianceReportForm(EMCUserData userData) {
        super("Stock Take Variance", EnumReports.INVENTORY_STOCK_TAKE_VARIANCE, userData);
