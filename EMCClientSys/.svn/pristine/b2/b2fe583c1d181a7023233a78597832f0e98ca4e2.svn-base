 ...
 * @author wikus
 */
public class SOPCommissionDetailedReport extends ReportFrame {

    /** Creates a new instance of DebtorsCustomerAgingDetailedReportForm */
    public SOPCommissionDetailedReport(EMCUserData userData) {
        super("Commission Statement", EnumReports.SOP_DETAILED_COMMISSION, userData);
    }
    ...
    protected JasperInformation createJasperInfo() {
        ...
        jasperInfo.setJasperTemplate("/emc/reports/sop/commission/SOPCommissionDetailedReport.jrxml");
        jasperInfo.setXmlNodePath("/emcmsg/emc.reports.sop.commission.SOPCommissionReportDS");
        jasperInfo.setReportTitle("Commission Statement");
    ...
    protected EMCCommandClass createReportCommand() {
        return new EMCCommandClass(EMCCommands.REPORT_COMAND.getId(), enumEMCModules.SOP.getId(), ServerSOPMethods.PRINT_DETAILED_COMMISSION_REPORT.toString());
    }

    @Override
    public EMCUserData getUserData() {
        EMCUserData userData = super.getUserData();
        userData.setUserData(0, 0);
        return userData;
    }
}
