 ...
 * @author wikus
 */
public class InventoryStocktakeRecountReducedReportForm extends StockTakeReportSuper {

    public InventoryStocktakeRecountReducedReportForm(EMCUserData userData) {
        super("Stock Take Recount - Reduced", EnumReports.INVENTORY_STOCK_TAKE_RECOUNt, userData);
    }
    ...
    protected JasperInformation createJasperInfo() {
        ...
        jasperInfo.setReportTitle("Stock Take Recount - Reduced");
