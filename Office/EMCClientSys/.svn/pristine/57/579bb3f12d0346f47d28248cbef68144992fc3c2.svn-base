 ...
 */
package emc.forms.debtors.display.printinstruction;

import emc.forms.debtors.display.customerinvoice.*;
 ...
 * @author riaan
 */
public class PrintInstructionForm extends BaseInternalFrame {
     ...
     */
    public PrintInstructionForm(EMCUserData userData) {
        super("Print Customer", true, true, true, true, userData);
