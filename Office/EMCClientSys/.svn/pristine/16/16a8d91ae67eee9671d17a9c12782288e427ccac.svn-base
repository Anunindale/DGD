 ...
 * @author wikus
 */
public class ItemClassificationForm4 extends BaseInternalFrame {
    ...
    public ItemClassificationForm4(EMCUserData userData){
        super("Classifications 4", true, true,true, true,userData);
        ...
        try{
            ...
            dataRelation = new emcDataRelationManagerUpdate(new emcGenericDataSourceUpdate(
                        enumEMCModules.INVENTORY.getId(),new emc.entity.inventory.classifications.InventoryItemClassification4(),userData),userData);
