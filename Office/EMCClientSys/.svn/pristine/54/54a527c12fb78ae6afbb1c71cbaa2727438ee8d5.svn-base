 ...
 * @author riaan
 */
public class ItemDimension1SetupForm extends BaseInternalFrame {
    ...
    public ItemDimension1SetupForm(EMCUserData userData) {
        super("Config", true, true, true, true, userData);
        ...
        try {
            ...
            dataRelation = new EMCControlLookupComponentDRM(new emcGenericDataSourceUpdate(
                    enumEMCModules.INVENTORY.getId(), new emc.entity.inventory.dimensions.datasource.InventoryItemDimension1SetupFormDS(), userData), userData) {

                @Override
                public void updatePersist(int rowIndex) {
                    if (isRowUpdated()) {
                        ItemDimension1SetupForm.this.changesMade = true;
                    }
                ...
                public void deleteRowCache(int rowIndex) {
                    if ((Long) getLastFieldValueAt("recordID") != 0) {
                        ...
                        toSend.add(EnumDimensions.DIMENSION1.toString());
            ...
            lkpItem = EMCItemLookupFactory.createItemControllLookup(dataRelation, txtItemDesc, InventoryItemDimension1Setup.class.getName(), copyUD);
            dataRelation.setLookup(lkpItem);


            //Position 4 of the dimension lookup popups has value "form".  This is 
            //used on the server to determine whether combinations should be generated
            userData.setUserData(4, "Lookup");
    ...
    private emcJPanel tabButtons() {
        ...
        pnlButtons.add(new RemoveInActive(this.dataRelation, InventoryItemDimension1Setup.class.getName()), gbc);
        y++;
    ...
    private void initFrame() {
        ...
        tabbedPanetop.add("Config", mainPane);
