 ...
 * @author wikus
 */
public class ItemClassificationForm5 extends BaseInternalFrame {
    ...
    public ItemClassificationForm5(EMCUserData userData){
        super("Classifications 5", true, true,true, true,userData);
        ...
        try{
            ...
            dataRelation = new emcDataRelationManagerUpdate(new emcGenericDataSourceUpdate(
                        enumEMCModules.INVENTORY.getId(),new emc.entity.inventory.classifications.InventoryItemClassification5(),userData),userData);
