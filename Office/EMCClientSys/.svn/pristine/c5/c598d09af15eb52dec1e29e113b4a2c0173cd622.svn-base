package emc.forms.hr.display.levelofexperience;
...
* @author claudette
*/
public class HRLevelOfExperienceForm extends BaseInternalFrame{

    private emcDataRelationManagerUpdate drm;

    /** Creates a new instance of HRLevelOfExperienceForm. */
    public HRLevelOfExperienceForm(EMCUserData userData) {
        super("Level Of Experience", true, true, true, true, userData);
        this.setBounds(20, 20, 650, 290);
        drm = new emcDataRelationManagerUpdate(new emcGenericDataSourceUpdate(new HRLevelOfExperience(), userData), userData);
        drm.setTheForm(this);
        this.setDataManager(drm);
        drm.setFormTextId1("levelOfExp");
