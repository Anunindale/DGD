 ...
 * @author wikus
 */
public class BaseCopyTableDataBackupFileSelectionDialog extends emcJDialog {

    private EMCUserData userData;
    private EMCFilePicker fpBackupFlie;

    public BaseCopyTableDataBackupFileSelectionDialog(EMCDesktop owner, EMCUserData userData) {
        super(owner, "EMC Backup", true);
    ...
    private void initDialog() {
        ...
        tabbed.add("Backup", selectionPane());
    ...
    private emcJPanel selectionPane() {
        ...
        fpBackupFlie.setSelectionMode(JFileChooser.DIRECTORIES_ONLY);
        ...
        emcJButton btnOK = new emcJButton("OK") {
            ...
            public void doActionPerformed(ActionEvent evt) {
                ...
                if (fpBackupFlie.getFile() == null) {
                    Logger.getLogger("emc").log(Level.SEVERE, "Please selecct a location to save the EMC Backup file.", userData);
                    return;
                }
                BaseCopyTableDataBackupFileSelectionDialog.this.dispose();
            }
        };
