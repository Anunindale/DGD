package emc.forms.hr.display.pivotalprogram;
 ...
 * @author claudette
 */
public class HRPivotalProgramForm extends BaseInternalFrame {

    private emcDataRelationManagerUpdate drm;

    /** Creates a new instance of HRPivotalProgramForm. */
    public HRPivotalProgramForm(EMCUserData userData) {
        super("Pivotal Program", true, true, true, true, userData);
        this.setBounds(20, 20, 650, 290);
        drm = new emcDataRelationManagerUpdate(new emcGenericDataSourceUpdate(new HRPivotalProgram(), userData), userData);
        drm.setTheForm(this);
        this.setDataManager(drm);
        drm.setFormTextId1("pivotalProgramId");
