package emc.forms.sop.display.changedatereason;
 ...
 * @author claudette
 */
public class SOPSalesOrderChangeDateReasonForm extends BaseInternalFrame {

    private emcDataRelationManagerUpdate drm;

    /** Creates a new instance of SOPSalesOrderChangeDateReasonForm. */
    public SOPSalesOrderChangeDateReasonForm(EMCUserData userData) {
        super("Sales Order Change Date Reason", true, true, true, true, userData);
        this.setBounds(20, 20, 650, 290);
        drm = new emcDataRelationManagerUpdate(new emcGenericDataSourceUpdate(new SOPSalesOrderChangeDateReason(), userData), userData);
        drm.setTheForm(this);
        this.setDataManager(drm);
        drm.setFormTextId1("reasonId");
