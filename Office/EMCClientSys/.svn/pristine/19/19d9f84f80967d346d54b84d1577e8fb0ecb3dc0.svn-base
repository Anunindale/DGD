 ...
 */
package emc.forms.creditors.display.invoiceregister;
 ...
 * @author wikus
 */
public class CreditorsInvoiceRegisterForm extends BaseInternalFrame implements RegisterFormInterface {
    ...
    public CreditorsInvoiceRegisterForm(EMCUserData userData) {
        ...
        dataRelation = new RegisterDRM(
                new emcGenericDataSourceUpdate(new CreditorsInvoiceRegister(), userData), false, userData) {
