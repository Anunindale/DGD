package emc.forms.hr.display.alternativeidtype;
...
* @author claudette
*/
public class HRAlternativeIdTypeForm extends BaseInternalFrame{

    private emcDataRelationManagerUpdate drm;

    /** Creates a new instance of HRAlternativeIdTypeForm. */
    public HRAlternativeIdTypeForm(EMCUserData userData) {
        super("Alternative Id Type", true, true, true, true, userData);
        this.setBounds(20, 20, 650, 290);
        drm = new emcDataRelationManagerUpdate(new emcGenericDataSourceUpdate(new HRAlternativeIdType(), userData), userData);
        drm.setTheForm(this);
        this.setDataManager(drm);
        drm.setFormTextId1("altIdType");
