 ...
 */
@Entity
@Table(name = "InventoryRequirementsPlanning")
public class InventoryRequirementsPlanning extends EMCEntityClass {
    ...
    @Temporal(TemporalType.DATE)
    private Date supplyCompletionDate;
    ...
    //Added Just for safty reason
    private BigDecimal totalQuantity = BigDecimal.ZERO;

    public InventoryRequirementsPlanning() {
    }
    ...
    public Date getSupplyCompletionDate() {
        return supplyCompletionDate;
    }

    public void setSupplyCompletionDate(Date supplyCompletionDate) {
        this.supplyCompletionDate = supplyCompletionDate;
    }

    @Override
    public EMCQuery buildQuery() {
        EMCQuery query = super.buildQuery();
        query.addAnd("demandClosed", false);
        query.addAnd("supplyClosed", false);
        return query;
    }
}
