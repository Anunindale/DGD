 ...
 */
@Entity
@Table(name = "SOPSalesEnquiry")
public class SOPSalesEnquiry extends EMCEntityClass {
    ...
    public SOPSalesEnquiry() {
    }

    public SOPSalesEnquiry(String userId, String customerId, String customerName, String marketingGroup, String itemId, String itemReference,
            ...
            String customField1, String customField2, String customField3, String customField4, String customField5, String salesRep, String recordType,
