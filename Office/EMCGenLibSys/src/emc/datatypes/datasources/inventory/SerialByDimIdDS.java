 ...
 * @author wikus
 */
public class SerialByDimIdDS extends SerialNo {

    public SerialByDimIdDS() {
        ...
        dsr.setSearchCriteria(new QueryManipulator() {
            ...
            public EMCQuery manipulateQuery(EMCQuery query, String PKField, String FKField, Object theValue, java.lang.String queryCondition, EMCUserData userData) {
                ...
                query.addAndCommaSeperated("itemSerialId", theValue.toString(), InventoryDimensionTable.class.getName(), EMCQueryConditions.fromString(queryCondition));
                return query;
            }
        });
