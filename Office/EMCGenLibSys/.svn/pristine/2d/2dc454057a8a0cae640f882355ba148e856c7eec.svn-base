 ...
 * @author wikus
 */
public class WarehouseByDimIdDS extends WarehouseFKNotMandatory {

    public WarehouseByDimIdDS() {
        ...
        dsr.setSearchCriteria(new QueryManipulator() {
            ...
            public EMCQuery manipulateQuery(EMCQuery query, String PKField, String FKField, Object theValue, java.lang.String queryCondition, EMCUserData userData) {
                ...
                query.addAndCommaSeperated("warehouseId", theValue.toString(), InventoryDimensionTable.class.getName(), EMCQueryConditions.fromString(queryCondition));
                return query;
            }
        });
