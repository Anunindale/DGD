 ...
 */
package emc.reports.sop.orderschedule;
 ...
 */
@Stateless
public class SOPOrderScheduleReportBean extends EMCReportBean implements SOPOrderScheduleReportLocal {

    /** Creates a new instance of SOPOrderScheduleReportBean. */
    public SOPOrderScheduleReportBean() {
    }
    ...
    public List<Object> getReportResult(List<Object> queryList, EMCUserData userData) {
        ...
        query.addField("salesOrderType", SOPSalesOrderMaster.class.getName()); //10
    ...
    public List<Object> manipulateQueryResult(List<Object> queryResult, java.util.Map<java.lang.String, java.lang.Object> paramMap, EMCUserData userData) {
        ...
        Map<Integer, SOPOrderScheduleReportDS> dsMap = new HashMap<Integer, SOPOrderScheduleReportDS>();
        //Keep track of the last record populated - reduce number of 'get' calls to Map.
        int lastKey = 0;
        SOPOrderScheduleReportDS lastDS = null;
        ...
        for (Object ob : queryResult) {
            ...
            String orderType = (String) result[10];
            String customerOrderNumber = (String) result[11];
            ...
            SOPOrderScheduleReportDS ds = null;
            ...
            if (keyString.hashCode() != lastKey) {
                ...
                if (ds == null) {
                    ds = new SOPOrderScheduleReportDS();
                    ...
                    ds.setCustomerOrderNumber(customerOrderNumber);

                    if (!isBlank(orderType)) {
                        ds.setOrderType(String.valueOf(Character.toUpperCase(orderType.charAt(0))));
                    }
