...
public interface OnlineUsersLocal {
    ...
    public int updateNumberOfUsers(emc.framework.EMCUserData userData);

    public long getEMCSessionNumber(java.lang.String userName, java.lang.String clientName, emc.framework.EMCUserData userData);
}
