 ...
 */
@Stateless
public class InventoryDimension1WhereUsedBean extends EMCEntityBean implements InventoryDimension1WhereUsedLocal {
    ...
    public Collection getDataInRange(Class theTable, EMCUserData userData, int start, int end) {
        ...
        if (!isBlank(dimensionId)) {
            ...
            InventoryDimension1WhereUsed record;
            Object[] data;
            for (Object o : relatedTableData) {
                data = (Object[]) o;
                record = new InventoryDimension1WhereUsed();
                record.setRecordID(1);
                record.setDimension1(dimensionId);
    ...
    private List<Object[]> fetchRelatedData(String dimensionId, EMCUserData userData) {
        ...
        query.addAnd("dimension1Id", dimensionId, InventoryItemDimensionCombinations.class.getName());
