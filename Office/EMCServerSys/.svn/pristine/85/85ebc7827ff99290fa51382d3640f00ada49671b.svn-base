 ...
 */
package emc.reports.debtors.transactiontotals.journaltransactiontotals;
...
import emc.reports.debtors.transactiontotals.DebtorsTransactionTotalsReportDS;
 ...
 */
@Stateless
public class DebtorsJournalTransactionTotalsReportBean extends EMCReportBean implements DebtorsJournalTransactionTotalsReportLocal {
    ...
    public List<Object> getReportResult(List<Object> parameters, EMCUserData userData) {
        ...
        query.addGroupBy(DebtorsJournalMaster.class.getName(), "journalDefinitionId");
        query.addGroupBy("referenceNumber");
        query.addGroupBy("transactionDate");
        query.addField("customerId");
        query.addField("journalDefinitionId", DebtorsJournalMaster.class.getName());
