...
//                
                try {
                    for (Field f : lineFields) {
                            ...
                            if ("customerChemical".equalsIgnoreCase(f.getName()) || "approved".equalsIgnoreCase(f.getName()) || "approvedDate".equalsIgnoreCase(f.getName()) || "approvedBy".equalsIgnoreCase(f.getName()) || "preferredShipName".equalsIgnoreCase(f.getName()) || "ownReference".equalsIgnoreCase(f.getName())) {
                            // do nothing skip
                            } else {
                                f.setAccessible(true);
