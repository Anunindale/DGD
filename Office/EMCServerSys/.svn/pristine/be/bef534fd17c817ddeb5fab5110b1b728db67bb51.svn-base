...
//            }
          ...
          String classId =line.getClassId();
           if(line.getClassId() != null){
               int charecterSize = line.getClassId().length();
               if(charecterSize == 4){
            ...
            ds.setClassPicPath(isBlank(filePath) ? null : fp + seperator + classId + ".png");
